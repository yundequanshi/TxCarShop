...
public class TXTouTiao extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		home_top_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				TXTouTiao.this.finish();
			}
		});
		String id = intent.getStringExtra("id");
		_webview.getSettings().setJavaScriptEnabled(true);
		_webview.loadUrl("http://121.42.149.98:8080/tx/mobile3/head/detail?id="
				+ id);
		init();
	}
	...
	private void init() {
		_webview.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				showProgressDialog(TXTouTiao.this);
			}
