 ...
 * 适配器 网络URL的图片.
 */
public class MLAccidentPhotoAdapter2 extends BaseAdapter {
  ...
  public GetRefusePhoto handler;

  public static interface GetRefusePhoto {

    void onGetRefusePhoto(String number);
  }

  public void setHandler(GetRefusePhoto handler) {
   ...
   */
  public MLAccidentPhotoAdapter2(Context context, List<String> imagePaths,
...
//		holder.mImageView2.setBackgroundDrawable(null);
    ...
    if (mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.ershouchetjann)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.fabiaotupian)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.mipmap.btn_add_img)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.mipmap.add_img)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.cemianzhengti)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.fadongjicang)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.qianfang45du)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.zhengqianfangtu)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.zhongkongqu)) ||
        mImagePaths.get(position).toString().equals(String.valueOf(R.drawable.zuoyiqu))) {
      holder.mImageView3.setVisibility(View.GONE);
      holder.mImageView1.setScaleType(ScaleType.FIT_START);
    } else {
      holder.mImageView1.setScaleType(ScaleType.FIT_XY);
...
//				Toast.makeText(mContext, "aaa", 1500).show();\
        handler.onGetRefusePhoto(String.valueOf(position));
  ...
  public void setItems(List<String> imagePaths) {
