 ...
 *
 */
public class MLCropImageActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.message_crop_image);
        init();
    }
    @Override
    ...
    private void init(){
        ...
        mSave = (Button) findViewById(R.id.okBtn);
        ...
        try{
            ...
            if(mBitmap==null){
            	Toast.makeText(MLCropImageActivity.this, "没有找到图片", 0).show();
    			finish();
            }else{
