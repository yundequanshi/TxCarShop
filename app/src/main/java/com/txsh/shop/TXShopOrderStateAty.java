 ...
 */
public class TXShopOrderStateAty extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String type = (String) getIntentData();
        if(MLStrUtil.compare(type,"1")){
            this.type = 1;
            mTvTitle.setText("待付款");
            mListView.setAdapter(mAdapterDfk);
            initDataDfk();
        }else if(MLStrUtil.compare(type,"2")){
            this.type = 2;
            mTvTitle.setText("待收货");
            mListView.setAdapter(mAdapterDsh);
            initDataDsh();
        }else if(MLStrUtil.compare(type,"3")){
            this.type = 3;
            mTvTitle.setText("已完成");
    ...
    private void initView() {
        mAdapterDfk = new TXShopOrderDfkAdapter(TXShopOrderStateAty.this,R.layout.tx_item_shop_dfk);
        mAdapterDsh = new TXShopOrderDshAdapter(TXShopOrderStateAty.this,R.layout.tx_item_shop_ysh);
        mAdapterYsh = new TXShopOrderYshAdapter(TXShopOrderStateAty.this,R.layout.tx_item_shop_ysh);
        mListView.setAdapter(mAdapterDfk);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (type == 1) {
                    startAct(TXShopOrderStateAty.this, TXShopOrderDetailAty.class, mAdapterDfk.getItem(position));
                } else if (type == 2) {
                    startAct(TXShopOrderStateAty.this, TXShopOrderDetailAty.class, mAdapterDsh.getItem(position));
                } else {
                    startAct(TXShopOrderStateAty.this, TXShopOrderDetailAty.class, mAdapterYsh.getItem(position));
                }
            }
        });
    ...
    public void eventOnClick(TXEventModel eventModel){
        ...
        switch (eventModel.type){
            ...
            case MLConstants.EVENT_PARAM_ORDER_EVALUATE:{
                TXShopOrderRes.TXShopOrderData data = (TXShopOrderRes.TXShopOrderData) eventModel.obj;
                      startAct(TXShopOrderStateAty.this, TXShopPJChatAty.class, data.id);
                break;
            }
            //付款
            ...
            case MLConstants.EVENT_PARAM_ORDER_LOGISTICAL:{
                TXShopOrderRes.TXShopOrderData data = (TXShopOrderRes.TXShopOrderData) eventModel.obj;
                startAct(TXShopOrderStateAty.this,TXShopLogisticalAty.class,data);
                break;
            }
    ...
    private void initDataDfk(){
        ...
        loadDataWithMessage(TXShopOrderStateAty.this, "正在加载，请稍等...", message2);
    }
    ...
    private void cancelOrder(final String id){
        AlertDialog.Builder builder = MLDialogUtils.getAlertDialog(TXShopOrderStateAty.this);
        builder.setTitle("提示");
    ...
    private void payWx(int type){
      /*  double price = Double.parseDouble(mDataPay.productPrice);
        ...
        loadDataWithMessage(TXShopOrderStateAty.this, "正在支付，请稍等...", message2);
    }
    ...
    public void alipayAffirm(){
        ...
        loadDataWithMessage(TXShopOrderStateAty.this, "正在确认，请稍等...", message2);
    }

    private void payForAlipay(String  data) {
        MLPayUtils.payForAlipay(TXShopOrderStateAty.this, data, mHandler);
    }
                ...
                case HTTP_RESPONSE_PAY_YUE_CHECK:{
                   ...
                   /* money:修理厂的余额
                    ...
                    if(ret.datas.money>ret.datas.payCount){
                        ...
                        AlertDialog builder =   MLDialogUtils.getAlertDialog(TXShopOrderStateAty.this).setTitle("提示")
    ...
    private void initWeixin() {
        api = WXAPIFactory.createWXAPI(TXShopOrderStateAty.this, APIConstants.APP_ID);
    }
