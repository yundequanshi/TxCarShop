...
public class TxShopSaleAty extends BaseActivity {
    ...
    private void initView() {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startAct(TxShopSaleAty.this, TXShopDetailAty.class,mlShopCarData.get(position));
            }
        });
    ...
    private void initShopList() {
        ...
        ZMHttpRequestMessage message1 = new ZMHttpRequestMessage(ZMHttpType.RequestType.TX_SHOP_PRODUCT_SALE, null, param,
