 ...
 */
public class TXShopAddressAty extends BaseActivity {
    ...
    private void initView() {
        mAdapter = new TXMyAddressAdapter(TXShopAddressAty.this,R.layout.tx_item_address_my);
    ...
    private void initData(){
        ...
        loadDataWithMessage(TXShopAddressAty.this, "正在加载，请稍等...", message2);
    }
    ...
    public void addOnClick(View view){
        startAct(TXShopAddressAty.this,TXShopAddressAddAty.class,"",1);
    }
