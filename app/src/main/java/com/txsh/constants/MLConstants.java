...
public class MLConstants {
	...
	public static final String CARSHOP_HTTP_TAG = "Q3i1Pei1";
	
	
	public static final int RESULT_BUSINESS = 10;
	public static final int RESULT_ACCEIDENT_ADD = 11;

	public static final String  PAY_PARAM_BODY= "汽配商城订单支付";

    public static final String  PARAM_CATALOG_ID= "1";
    ...
    public static final int MY_PART_CAR1=600;   
    public static final int MY_PAY_PWD= 345;
    public static final int MY_PART_CAR_CHILD= 346;

    public static final int PART_DEPOT= 338;    
    public static final int PART_DEPOT_DETAIL= 339;

    public static final int TX_INFO_DETAIL= 350;
    public static final int HOME_BUSINESS_YOU_LIST= 880;
    public static final int HOME_SECOND_HAND_CAR= 1000;
    ...
    public static final int Second_Serach= 999;
    public static final int INTERACTLIST= 100001;
    public static final int SELECT_TYPE= 100002;
    ...
    public static final String PARAM_LOGIN_NUMBER= "mobile";
    ...
    public static final int EVENT_PARAM_ACCIDENT_SELL= 0;
    public static final int EVENT_PARAM_ACCIDENT_DEL= 1;
    public static final int EVENT_PARAM_LEAVE_SELL= 2;
    public static final int EVENT_PARAM_LEAVE_DEL= 3;
    public static final int EVENT_PARAM_ORDER_CANCEL= 4;
    public static final int EVENT_PARAM_ORDER_AFFIRM= 5;
    public static final int EVENT_PARAM_ORDER_QUIT= 6;
    public static final int EVENT_PARAM_ORDER_EVALUATE= 7;
    public static final int EVENT_PARAM_ORDER_PAY= 8;
    public static final int EVENT_PARAM_ORDER_PAY_WXOK= 9;
    public static final int EVENT_PARAM_ORDER_LOGISTICAL= 10;
    ...
    //===============环信==========start=============
    public static final int EVENT_CONTACT_ADD = 1001;
    public static final int EVENT_GROUP_CONTACT = 1002;
    public static final int EVENT_NOTIFY_FRIEND = 1003;
    public static final int EVENT_NOTIFY_GROUP_INVITE = 1004;
    public static final int EVENT_FRIEND_AGREE = 1005;
    public static final int EVENT_APPLY_GROUP = 1006;
    //===============环信===========end============
    ...
    public static final String ACACHE_CM_LOGIN_USER = "ACACHE_CM_LOGIN_USER";
}
