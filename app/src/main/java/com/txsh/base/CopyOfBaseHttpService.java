...
import com.txsh.http.ZMHttpType.ResponseType;
...
public class CopyOfBaseHttpService {
	...
	protected <T> T post(ZMHttpRequestMessage httpMessage, Class<T> cls,
			boolean isCache) throws ZMParserException, ZMHttpException {
		return post(httpMessage, cls, isCache, ResponseType.JSON);
	}
	
	protected <T> T post(ZMHttpRequestMessage httpMessage, Class<T> cls) throws ZMParserException, ZMHttpException {
