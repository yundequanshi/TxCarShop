...
public class MLIncidentAdd1Aty extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MLAccidentAdd1Adapter(MLIncidentAdd1Aty.this, R.layout.item_accident_photo);
        mGridPhoto.setAdapter(mAdapter);
        mGridPhoto.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                String s[] = {"删除"};
                AlertDialog builder = MLDialogUtils.getAlertDialog(MLIncidentAdd1Aty.this)
    ...
    public void camera(View view) {
        ...
        if (view.getId() == R.id.accident_tv_1) {
            //相册
            MLPhotoUtil.choose(MLIncidentAdd1Aty.this, 0);
        } else {
            //拍照
            MLPhotoUtil.choose(MLIncidentAdd1Aty.this, 1);
        }
    }
    ...
    public void nextOnClick(View view) {
       ...
       // startAct(MLAccidentAdd1Aty.this,MLAccidentAdd2Aty.class,mPath);
        Intent intent = new Intent(MLIncidentAdd1Aty.this,MLIncidentAdd2Aty.class);
