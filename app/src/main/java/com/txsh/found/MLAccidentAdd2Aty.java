...
public class MLAccidentAdd2Aty extends BaseActivity {
    ...
    public void fillOnClick(View view){
        switch (view.getId()){
            ...
            //车型名称
            startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(1,_niceTv.getText().toString()),1);
                break;
            }
            ...
            case R.id.accident_tv_mileage:{
                //行驶里程
                startAct(MLAccidentAdd2Aty.this, MLAccidentEditAty.class, new MeMapData(2,_mileageTv.getText().toString()), 1);
                break;
            }
            case R.id.accident_tv_damaged:{
                //受损部位
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(3,_damagedTv.getText().toString()),1);
                break;
            }
            case R.id.accident_tv_oldprice:{
                //买时裸车价
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(4,_oldpriceTv.getText().toString()),1);
                break;
            }
            case R.id.accident_tv_displacement:{
                //排量
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(5,_displacementTv.getText().toString()),1);
                break;
            }
            case R.id.accident_tv_price:{
                //预售价格
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(6,_priceTv.getText().toString()),1);
                break;
            }
            case R.id.accident_tv_title:{
                //姓名
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(7,_nameTv.getText().toString()),1);
                break;
            }
            case R.id.accident_tv_phone:{
                //电话
                startAct(MLAccidentAdd2Aty.this,MLAccidentEditAty.class,new MeMapData(8,_phoneTv.getText().toString()),1);
                break;
            }
