...
public class MLIncidentAdd2Aty extends BaseActivity {
    ...
    public void fillOnClick(View view){
        switch (view.getId()){
            ...
            //车型名称
            startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(1,_niceTv.getText().toString()),1);
                break;
            }
            ...
            case R.id.leave_tv_child:{
                //子车型
                startAct(MLIncidentAdd2Aty.this, MLIncidentEditAty.class, new MeMapData(2, _childTv.getText().toString()), 1);
                break;
            }
            case R.id.leave_tv_displacement:{
                //排量
                startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(3,_displacementTv.getText().toString().replace("L","")),1);
                break;
            }
            case R.id.leave_tv_oldprice:{
                //原价
                startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(4,_oldpriceTv.getText().toString().replace("元","")),1);
                break;
            }
            case R.id.leave_tv_price:{
                //现价
                startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(5,_priceTv.getText().toString().replace("元","")),1);
                break;
            }
            case R.id.leave_tv_name:{
                //姓名
                startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(6,_nameTv.getText().toString()),1);
                break;
            }
            case R.id.leave_tv_phone:{
                //电话
                startAct(MLIncidentAdd2Aty.this,MLIncidentEditAty.class,new MeMapData(7,_phoneTv.getText().toString()),1);
                break;
            }
