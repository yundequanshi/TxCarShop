...
public class MLDepotOfferDeatilAdapter extends AdapterBase<MLAccidentQuotesData>{

	private Context _context;
	
	public MLDepotOfferDeatilAdapter(Context _context) {
		super();
	...
	class ItemView extends LinearLayout{
		...
		private void init(){
			View view = LayoutInflater.from(_context).inflate(R.layout.depot_offer_detail_item, null);
			addView(view);   
