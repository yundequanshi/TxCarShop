...
/*	@ViewInject(R.id.personal_btn_del)
	...
	public MLLoginCityPop(Activity context,final IEvent<String> event) {
		super(context);
        final View view = LayoutInflater.from(context).inflate(R.layout.login_city, null);
        ViewUtils.inject(this, view);
        
    	_cityPicker = (CityPicker) view.findViewById(R.id.login_citypicker);
  		_okBtn = (TextView) view.findViewById(R.id.login_city_ok);
        _closeBtn = (ImageView) view.findViewById(R.id.btn_close);
