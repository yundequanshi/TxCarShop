...
import com.txsh.widget.MLTabGroup.IRadioCheckedListener;

import java.util.List;

public class MLBusinessDetailMapAct extends BaseActivity implements  OnGetRoutePlanResultListener{
	...
	public  MLHomeBusiness1Data _business;
...
private void initView() {
	...
	private void initMarkerClick(){
		mBaiduMap.setOnMarkerClickListener(new OnMarkerClickListener() {
			public boolean onMarkerClick(final Marker marker) {  
				//获取坐标的信息
				MLHomeBusiness1Data data = (MLHomeBusiness1Data) marker.getExtraInfo().get("data");
				MLHomeMapPopView pop = new MLHomeMapPopView(MLBusinessDetailMapAct.this);
				...
				_phonePop = new MLHomeMapPhonePop(MLBusinessDetailMapAct.this,new PopOnItemClick(data));
	...
	private void initOverlayData() {
	 /*   ZMHttpRequestMessage message1 = new ZMHttpRequestMessage(RequestType.HOME_MAP, null, null, _handler, HTTP_RESPONSE_MAP, MLHomeServices.getInstance());
		...
		if(intent!=null){
			_business = (MLHomeBusiness1Data) intent.getSerializableExtra("obj");
			Bundle bundle = new Bundle();
			bundle.putSerializable("data", _business);
			LatLng llA = new LatLng(_business.lan, _business.lon);
...
/*		LatLng llA = new LatLng(36.687932, 117.078866);
    ...
    *  POP 弹出点击事件 （拨打电话，步行，公交车.....）
	...
	public class  PopOnItemClick  implements OnClickListener{
		LatLng _ll;
		MLHomeBusiness1Data _data;
		public PopOnItemClick(MLHomeBusiness1Data data) {
			_ll =  new LatLng(data.lan,data.lon);
			_data = data;
		}
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(MLBusinessDetailMapAct.this);
		...
		try {
			...
			builder.setPositiveButton("确认", new DialogInterface. OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					dialog.dismiss();
					BaiduMapNavigation.getLatestBaiduMapApp(MLBusinessDetailMapAct.this);
				}
			});
