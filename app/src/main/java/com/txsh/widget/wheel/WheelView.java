...
public class WheelView extends TosGallery {
    ...
    private void initialize(Context context) {
        ...
        this.mSelectorDrawable = getContext().getResources().getDrawable(R.drawable.widget_wheel_val);
        ...
        this.setBackgroundResource(R.drawable.widget_wheel_bg);
