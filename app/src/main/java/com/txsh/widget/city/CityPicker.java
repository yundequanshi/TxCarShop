...
import com.txsh.R;
import com.txsh.widget.city.ScrollerNumberPicker.OnSelectListener;
...
public class CityPicker extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.widget_city_picker, this);
