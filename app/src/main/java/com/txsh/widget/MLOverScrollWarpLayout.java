...
public class MLOverScrollWarpLayout extends LinearLayout {
    ...
    public MLOverScrollWarpLayout(Context context, AttributeSet attr) {
        super(context, attr);
    ...
    public MLOverScrollWarpLayout(Context context) {
        super(context);
        this.setOrientation(LinearLayout.VERTICAL);
        // ��ʼ��ƽ��������
        mScroller = new Scroller(getContext(), new OvershootInterpolator(OVERSHOOT_TENSION));
