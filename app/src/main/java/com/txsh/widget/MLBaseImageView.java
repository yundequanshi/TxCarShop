...
public abstract class MLBaseImageView extends ImageView {
    private static final String TAG = MLBaseImageView.class.getSimpleName();
    ...
    public MLBaseImageView(Context context) {
        super(context);
        sharedConstructor(context);
    }

    public MLBaseImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructor(context);
    }

    public MLBaseImageView(Context context, AttributeSet attrs, int defStyle) {
