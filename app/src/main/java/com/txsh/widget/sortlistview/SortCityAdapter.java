...
public class SortCityAdapter extends BaseAdapter implements SectionIndexer {
  ...
  private List<MLHomeCityData> list = null;
  private Context mContext;

  public SortCityAdapter(Context mContext, List<MLHomeCityData> list) {
  ...
  public View getView(final int position, View view, ViewGroup arg2) {
    final MLHomeCityData mContent = list.get(position);
  ...
  class SortItemView extends BaseLayout {
    ...
    public void setData(MLHomeCityData data, int position) {
