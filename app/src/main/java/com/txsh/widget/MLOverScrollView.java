 ...
 * <strong>策略:</strong> 获取ScrollView的子视图并添加到自定义的{@link MLOverScrollWarpLayout}滚动视图中
 * 将滚动视图添加到ScrollView作为子视图,所有的弹性滚动都由{@link MLOverScrollWarpLayout}来完成
 *
 * @author King
 */
public class MLOverScrollView extends ScrollView {
     ...
     * 自定义的弹性滚动视图
     */
    private MLOverScrollWarpLayout mContentLayout;
    ...
    public MLOverScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initScrollView();
    }

    public MLOverScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MLOverScrollView(Context context) {
        this(context, null);
    }
    ...
    private void initOverScrollLayout() {
        ...
        if (mContentLayout == null) {
            ...
            // 初始化弹性滚动视图
            mContentLayout = new MLOverScrollWarpLayout(getContext());
            // 移除ScrollView所有视图
            this.removeAllViews();
