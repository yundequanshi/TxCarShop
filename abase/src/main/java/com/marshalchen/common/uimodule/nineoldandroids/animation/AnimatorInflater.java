...
public class AnimatorInflater {
    ...
    private static Animator createAnimatorFromXml(Context c, XmlPullParser parser,
            AttributeSet attrs, com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                createAnimatorFromXml(c, parser, attrs, (com.marshalchen.common.uimodule.nineoldandroids.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
