 ...
 *
 * BaseTransformer implement {@link com.marshalchen.common.uimodule.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.marshalchen.common.uimodule.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.marshalchen.common.uimodule.slider.Animations.BaseAnimationInterface}
 * work.
 *
