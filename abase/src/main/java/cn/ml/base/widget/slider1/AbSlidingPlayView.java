 ...
 */
package cn.ml.base.widget.slider1;
...
public class AbSlidingPlayView extends LinearLayout {
	...
	public void initView(Context context){
		...
		displayImage = BitmapFactory.decodeResource(getResources(), R.drawable.play_display);
		hideImage = BitmapFactory.decodeResource(getResources(), R.drawable.play_hide);
